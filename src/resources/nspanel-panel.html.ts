    ...
    RED.nodes.registerType('nspanel-panel', {
        ...
        defaults: {
            ...
            panelTimeout: {
                value: 10,
                required: true,
                validate: (v) => NSPanelLui.Editor.validate.isNumberInRange(v, PANEL_TIMEOUT_MIN, PANEL_TIMEOUT_MAX),
            },
            panelDimLow: {
                value: 10,
                required: true,
                validate: (v) => NSPanelLui.Editor.validate.isNumberInRange(v, PANEL_DIMVALUE_MIN, PANEL_DIMVALUE_MAX),
            },
            panelDimLowNight: {
                value: 10,
                required: true,
